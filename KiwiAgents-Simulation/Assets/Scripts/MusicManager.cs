...
MusicManager : MonoBehaviour{
    ...
    [SerializeField] private float ProbabilidadReproducir = 0.5f;        // Probabilidad para iniciar una canción cuando no se está reproduciendo
    ...
    Start(){
        ...
        // Iniciar la corutina para gestionar la música de forma aleatoria.
    ...
    RandomMusicRoutine(){
        while (true){
            ...
            if (songs == null || songs.Length == 0) {
                ...
                // Espera un intervalo aleatorio entre TiempoMinEspera y TiempoMaxEspera antes de la siguiente comprobación.
                yield return new WaitForSeconds(Random.Range(TiempoMinEspera, TiempoMaxEspera));
                // Continúa al siguiente ciclo de la corutina.
                continue;
            }
